                ...
                <div className="w-full max-w-[440px] bg-white dark:bg-slate-900 p-8 rounded-xl shadow-sm border border-slate-200 dark:border-slate-800">
                    <div className="flex flex-col items-center mb-8">
                        ...
                        <div className="flex items-center gap-1.5 mt-2 text-slate-500 dark:text-slate-400">
                            ...
                            <p className="text-sm font-medium">Secure fintech-grade login</p>
                        </div>
                    </div>
                    ...
                    <form className="space-y-5" onSubmit={handleSubmit}>
                        ...
                        <div className="flex flex-col gap-1.5">
                            <div className="flex justify-between items-center px-0.5">
                                ...
                                <a className="text-xs font-semibold text-primary dark:text-slate-300 hover:underline" href="#">Forgot password?</a>
                            </div>
                    ...
                    <div className="mt-8 pt-6 border-t border-slate-100 dark:border-slate-800 text-center">
                        <p className="text-sm text-slate-500 dark:text-slate-400">
                            ...
                            <Link className="font-bold text-primary dark:text-slate-300 hover:underline ml-1" href="/register">Start free trial</Link>
                        </p>
                    </div>
                </div>
            </main>
